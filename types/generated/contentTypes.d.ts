...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    meeting_time: Schema.Attribute.String;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNoticeNotice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_important: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notice.notice'
...
export interface ApiSermonSermon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bible_verse: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    sermon_date: Schema.Attribute.Date;
...
export interface ApiWorshipWorship extends Struct.CollectionTypeSchema {
  collectionName: 'worships';
  info: {
    displayName: 'Worship (\uC608\uBC30 \uC548\uB0B4) ';
    pluralName: 'worships';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    worship_type: Schema.Attribute.String;
  };
}
